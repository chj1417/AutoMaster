...
class MainWindow(QMainWindow):
    ...
    def init_ribbon(self):
        ...
        info_panel.add_ribbon_widget(IconButton(self, self._about_action, True))
        info_panel.add_ribbon_widget(IconButton(self, self._license_action, True))
    ...
    def on_about(self):
        text = "About Read From CoreConfig.ini"
        QMessageBox().about(self, "About MainTitle From CoreConfig.ini", text)
